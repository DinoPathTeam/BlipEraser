...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "overview_rebuild_failed": "No se pudo actualizar la lista de aplicaciones; pulsa «Actualizar lista» para reintentar.",
        "table_render_failed": "No se pudo refrescar la tabla; pulsa «Actualizar lista» para reintentar.",
        "cleanup_junk": "Basura",
        "cleanup_cache": "Caché",
    ...
    "en": {
        ...
        "apps_count_label": "{count} apps",
        "overview_rebuild_failed": "Could not update the applications list; press 'Refresh list' to retry.",
        "table_render_failed": "Could not refresh the table; press 'Refresh list' to retry.",
        "cleanup_junk": "Junk",
        "cleanup_cache": "Cache",
        "cleanup_logs": "Logs",
